...
export const FolderFormats = {
  ...
  "YYYY.MM.DD_tag_hash_projectName":
    "%(yyyymmdd)s_%(tag)s_%(hash)s_%(projectName)s",
  "YYYY.MM.DD_projectName_tag_hash":
    "%(yyyymmdd)s_%(projectName)s_%(tag)s_%(hash)s",
  "YYYY.MM.DD_projectName_hash_tag":
    "%(yyyymmdd)s_%(projectName)s_%(hash)s_%(tag)s",
  ...
  "projectName_YYYY.MM.DD_hash_tag":
    "%(projectName)s_%(yyyymmdd)s_%(hash)s_%(tag)s",
  "projectName_YYYY.MM.DD_tag_hash":
    "%(projectName)s_%(yyyymmdd)s_%(tag)s_%(hash)s",
};
